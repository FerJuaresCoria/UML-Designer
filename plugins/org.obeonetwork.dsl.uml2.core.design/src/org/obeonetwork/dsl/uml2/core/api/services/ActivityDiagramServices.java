...
public class ActivityDiagramServices extends AbstractDiagramServices {
	...
	/**
	 * Return the given context object if it's an {@link ExpansionRegion} or find it into the parent
	 * elements.<br>
	 * This is used to compute the context of Activity diagram creation tools. Activity Nodes & Actions can be
	 * created and owned within an {@link ExpansionRegion}.
	 *
	 * @param context
	 *            the context object on which to execute this service.
	 * @return the parent ExpansionRegion of the context object
	 */
	public ExpansionRegion findParentExpansionRegion(Element context) {
		if (context instanceof ExpansionRegion) {
			return (ExpansionRegion)context;
		}

		if (context.eContainer() != null) {
			return findParentExpansionRegion((Element)context.eContainer());
		}
	...
	/**
	 * Check if {@link ExpansionRegion} is an parent
	 * @param context 
	 *            the context object on which to execute this service.
	 * @return true if a parent is an ExpansionRegion
	 */
	public boolean existsExpansionRegionParent(Element context)
	{
		return (findParentExpansionRegion(context) != null);
	}
